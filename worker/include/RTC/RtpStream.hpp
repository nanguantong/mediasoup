...
namespace RTC
{
	...
	public:
		struct Params
		{
			...
			bool useNack{ false };
			bool usePli{ false }; // nanuns add: Picture Loss Indication
			bool useFir{ false }; // nanuns add:Full Intra Request
			bool useInBandFec{ false };
			bool useDtx{ false }; // nanuns add:Discontinuous Transmission
